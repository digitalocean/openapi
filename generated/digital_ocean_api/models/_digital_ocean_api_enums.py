...
class ActionStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AlertPolicyCompare(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):

    GREATER_THAN = "GreaterThan"
    LESS_THAN = "LessThan"

class AlertPolicyRequestCompare(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):

    GREATER_THAN = "GreaterThan"
    LESS_THAN = "LessThan"

class AlertPolicyRequestType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AlertPolicyRequestWindow(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AlertPolicyType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AlertPolicyWindow(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AppAlertPhase(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AppAlertProgressStepStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AppAlertSpecOperator(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):

    UNSPECIFIED_OPERATOR = "UNSPECIFIED_OPERATOR"
    GREATER_THAN = "GREATER_THAN"
    LESS_THAN = "LESS_THAN"

class AppAlertSpecRule(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AppAlertSpecWindow(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AppComponentInstanceBaseInstanceSizeSlug(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AppDatabaseSpecEngine(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """* MYSQL: MySQL
    * PG: PostgreSQL
    * REDIS: Redis
    """
...
class AppDomainSpecType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AppJobSpecKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AppsDeploymentPhase(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AppsDeploymentProgressStepStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AppsDomainPhase(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AppsImageSourceSpecRegistryType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AppSpecRegion(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AppVariableDefinitionScope(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AppVariableDefinitionType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class BillingHistoryType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class CdnEndpointTtl(with_metaclass(CaseInsensitiveEnumMeta, int, Enum)):
...
class CertificateCreateBaseType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class CertificateState(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ClusterStatusState(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class DatabaseClusterEngine(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class DatabaseClusterStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class DatabaseReplicaStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """A string representing the current status of the database cluster.
    """
...
class DatabaseUserRole(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class Distribution(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class DropletSnapshotType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class DropletStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class Enum69(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):

    PRIVATE = "private"
    PUBLIC = "public"

class Enum70(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):

    INBOUND = "inbound"
    OUTBOUND = "outbound"

class Enum79(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):

    DROPLET = "droplet"
    VOLUME = "volume"

class Enum83(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class Enum84(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class Enum85(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):

    APPLICATION = "application"
    DISTRIBUTION = "distribution"

class FirewallRuleBaseProtocol(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class FirewallRuleType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class FirewallStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ForwardingRuleEntryProtocol(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ForwardingRuleTargetProtocol(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class GarbageCollectionStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class HealthCheckProtocol(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ImageActionBaseType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ImageStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class InstanceSizeCpuType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class KubernetesNodePoolTaintEffect(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class LoadBalancerBaseAlgorithm(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class LoadBalancerBaseSize(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class LoadBalancerBaseStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class MaintenancePolicyDay(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class MetricsStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):

    SUCCESS = "success"
    ERROR = "error"

class MysqlSettingsAuthPlugin(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class NetworkV4Type(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class NodeStatusState(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class PostContentSchemaTierSlug(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class PostgresDefaultToastCompression(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class PostgresLogErrorVerbosity(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class PostgresLogLinePrefix(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class PostgresPgStatStatementsTrack(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class PostgresTrackCommitTimestamp(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class PostgresTrackFunctions(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class PostgresTrackIoTiming(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ProjectBaseEnvironment(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class RedisAclChannelsDefault(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class RedisMaxmemoryPolicy(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class RedisPersistence(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class RegionSlug(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class RegistryCreateRegion(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class RegistryCreateSubscriptionTierSlug(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class SnapshotResourceType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class StickySessionsType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class SubscriptionTierExtendedEligibilityReasonsItem(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):

    OVER_REPOSITORY_LIMIT = "OverRepositoryLimit"
    OVER_STORAGE_LIMIT = "OverStorageLimit"

class TagResourceResourcesItemResourceType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class UpdateEndpointTtl(with_metaclass(CaseInsensitiveEnumMeta, int, Enum)):
    """The amount of time the content is cached by the CDN's edge servers in seconds. TTL must be one
    of 60, 600, 3600, 86400, or 604800. Defaults to 3600 (one hour) when excluded.
    """
...
class VolumeActionPostBaseType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
