...
from ...operations._upgrade_operations import build_kubernetes_cluster_request
T = TypeVar('T')
...
class UpgradeOperations:
    ...
    async def kubernetes_cluster(
        self,
        body: _models.Paths1Cfx96QV2KubernetesClustersClusterIdUpgradePostRequestbodyContentApplicationJsonSchema,
        **kwargs: Any
