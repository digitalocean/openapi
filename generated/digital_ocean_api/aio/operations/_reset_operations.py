...
from ...operations._reset_operations import build_auth_request
T = TypeVar('T')
...
class ResetOperations:
    ...
    async def auth(
        self,
        body: "_models.PathsQ9AxjgV2DatabasesDatabaseClusterUuidUsersUsernameResetAuthPostRequestbodyContentApplicationJsonSchema",
        **kwargs: Any
