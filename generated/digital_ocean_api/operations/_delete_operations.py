...
def build_kubernetes_node_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    skip_drain = kwargs.pop('skip_drain', 0)  # type: Optional[int]
    replace = kwargs.pop('replace', 0)  # type: Optional[int]
    ...
    if skip_drain is not None:
        _query_parameters['skip_drain'] = _SERIALIZER.query("skip_drain", skip_drain, 'int', maximum=1, minimum=0)
    if replace is not None:
        _query_parameters['replace'] = _SERIALIZER.query("replace", replace, 'int', maximum=1, minimum=0)
...
def build_volume_by_name_request(
    **kwargs  # type: Any
    ...
    region = kwargs.pop('region', None)  # type: Optional[Union[str, "_models.RegionSlug"]]
