...
def build_auth_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/v2/databases/{database_cluster_uuid}/users/{username}/reset_auth")
...
class ResetOperations(object):
    ...
    def auth(
        self,
        body,  # type: "_models.PathsQ9AxjgV2DatabasesDatabaseClusterUuidUsersUsernameResetAuthPostRequestbodyContentApplicationJsonSchema"
        **kwargs  # type: Any
    ):
        ...
        :param body:
        :type body:
         ~digital_ocean_api.models.PathsQ9AxjgV2DatabasesDatabaseClusterUuidUsersUsernameResetAuthPostRequestbodyContentApplicationJsonSchema
        ...
        _json = self._serialize.body(body, 'PathsQ9AxjgV2DatabasesDatabaseClusterUuidUsersUsernameResetAuthPostRequestbodyContentApplicationJsonSchema')
        ...
        request = build_auth_request(
            ...
            json=_json,
            template_url=self.auth.metadata['url'],
        )
    ...
    auth.metadata = {'url': "/v2/databases/{database_cluster_uuid}/users/{username}/reset_auth"}  # type: ignore
