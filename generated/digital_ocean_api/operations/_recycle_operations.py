...
def build_kubernetes_node_pool_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/v2/kubernetes/clusters/{cluster_id}/node_pools/{node_pool_id}/recycle")
...
# fmt: on
class RecycleOperations(object):
    """
    .. warning::
    ...
    def kubernetes_node_pool(
        self,
        body,  # type: _models.Paths1YaighgV2KubernetesClustersClusterIdNodePoolsNodePoolIdRecyclePostRequestbodyContentApplicationJsonSchema
        **kwargs  # type: Any
    ):
