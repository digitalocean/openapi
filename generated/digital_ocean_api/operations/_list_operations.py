...
def build_registry_repositories_v2_request(
    ...
    **kwargs  # type: Any
    ...
    per_page = kwargs.pop('per_page', 20)  # type: Optional[int]
    page = kwargs.pop('page', 1)  # type: Optional[int]
    page_token = kwargs.pop('page_token', None)  # type: Optional[str]
    ...
    if page_token is not None:
        _query_parameters['page_token'] = _SERIALIZER.query("page_token", page_token, 'str')
...
def build_all_snapshots_request(
    **kwargs  # type: Any
    ...
    per_page = kwargs.pop('per_page', 20)  # type: Optional[int]
    page = kwargs.pop('page', 1)  # type: Optional[int]
    resource_type = kwargs.pop('resource_type', None)  # type: Optional[Union[str, "_models.Enum79"]]
    ...
    if resource_type is not None:
        _query_parameters['resource_type'] = _SERIALIZER.query("resource_type", resource_type, 'str')
